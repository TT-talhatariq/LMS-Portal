...
import CourseSidebar from '@/app/components/studentDashboard/CourseSidebar';
import SidebarToggle from '@/app/components/studentDashboard/SidebarToggle';
...
const VideoDetail = () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-teal-50 flex items-center justify-center p-4">
      <div className="text-center text-red-500 bg-white/80 backdrop-blur-sm rounded-xl lg:rounded-2xl p-6 lg:p-8 border border-red-200/60 shadow-sm max-w-md w-full">
        <div className="w-12 h-12 lg:w-16 lg:h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
          <X className="h-6 w-6 lg:h-8 lg:w-8 text-red-500" />
        </div>
  ...
  const LoadingState = () => (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-teal-50 flex items-center justify-center p-4">
      <div className="text-center text-slate-500 bg-white/80 backdrop-blur-sm rounded-xl lg:rounded-2xl p-6 lg:p-8 border border-slate-200/60 shadow-sm max-w-md w-full">
        <div className="w-12 h-12 lg:w-16 lg:h-16 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full flex items-center justify-center mx-auto mb-4">
          <Loader2 className="h-6 w-6 lg:h-8 lg:w-8 text-white animate-spin" />
        </div>
        <p className="text-base lg:text-lg font-medium mb-2">
          Loading video...
        </p>
  ...
  const VideoNotFoundState = () => (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-teal-50 flex items-center justify-center p-4">
      <div className="text-center text-slate-500 bg-white/80 backdrop-blur-sm rounded-xl lg:rounded-2xl p-6 lg:p-8 border border-slate-200/60 shadow-sm max-w-md w-full">
        ...
        <p className="text-base lg:text-lg font-medium mb-2">Video not found</p>
        <p className="text-xs lg:text-sm text-slate-600 mb-4">
  ...
  return (
    <div className="flex bg-gradient-to-br from-slate-50 via-emerald-50 to-teal-50 min-h-screen">
      <div className="flex-1">
        <div className="bg-white/95 backdrop-blur-md border-b border-slate-200/60 shadow">
              ...
              <div className="flex items-center gap-2 lg:gap-4 min-w-0 flex-1">
                ...
                >
                  <Button
                    variant="ghost"
                    size="sm"
                    className="text-slate-600 hover:text-slate-800 hover:bg-slate-100 text-xs lg:text-sm px-2 lg:px-3"
                  >
                ...
                <h1 className="hidden lg:block text-[16px] font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent break-words">
                  {video.title}
                </h1>
              </div>
              <Button
        ...
        <div className="mx-auto px-4 lg:px-6 py-6 lg:py-8">
          <div className="space-y-4 lg:space-y-6">
            <div className="relative bg-white/80 backdrop-blur-sm rounded-xl lg:rounded-2xl border border-slate-200/60 shadow-sm overflow-hidden">
              {isFetching && data && (
                <div className="absolute inset-0 bg-white/70 backdrop-blur-sm flex items-center justify-center z-20 transition-all duration-300">
                  <div className="text-center">
                    <Loader2 className="w-8 h-8 lg:w-10 lg:h-10 text-emerald-500 animate-spin mx-auto mb-2" />
                    <p className="text-sm text-slate-600">Switching video...</p>
                  </div>
                </div>
              )}
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl lg:rounded-2xl p-4 lg:p-6 border border-slate-200/60 shadow-sm">
              <div className="block lg:hidden mb-4">
                <h1 className="text-lg font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent break-words">
                  {video.title}
                </h1>
              </div>
      ...
      <CourseSidebar isOpen={isSidebarOpen} onClose={closeSidebar} />
